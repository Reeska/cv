...
const VueIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg width="69.43" height="64" viewBox="0 0 256 236" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path fill="#FCA326" d="M14.956 91.104L.642 135.16a9.752 9.752 0 0 0 3.542 10.903l123.891 90.012l-113.12-144.97Z"/>
      ...
      <path fill="#FCA326" d="m241.194 91.104l14.314 44.056a9.752 9.752 0 0 1-3.543 10.903l-123.89 90.012l113.119-144.97Z"/>
